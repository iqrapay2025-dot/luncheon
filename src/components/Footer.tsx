...
export default function Footer({ navigate }: { navigate: NavigateFn }) {
  return (
    <footer style={{ background: '#0F0A18', borderTop: '1px solid rgba(212,162,76,0.2)' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '56px 24px 32px' }}>
        ...
        >
          {/* Brand column */}
          <div>
            <div style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 700, color: '#D4A24C', fontSize: 18, marginBottom: 6 }}>
              MSSN UNILORIN
            </div>
            <div style={{ color: '#E8C784', fontSize: 10, letterSpacing: '0.12em', marginBottom: 16 }}>
              GRAND LUNCHEON 2026
            </div>
            <p style={{ color: 'rgba(253,248,240,0.55)', fontSize: 13, lineHeight: '1.7', maxWidth: 240 }}>
              Muslim Students&apos; Society of Nigeria, University of Ilorin Branch. Celebrating excellence, faith, and community.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <div style={{ color: '#D4A24C', fontWeight: 600, fontSize: 12, letterSpacing: '0.1em', marginBottom: 16 }}>
              QUICK LINKS
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                <button
                  ...
                  onMouseOut={(e) => (e.currentTarget.style.color = 'rgba(253,248,240,0.7)')}
                >
                  {label}
                </button>
              ))}
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {[
                ...
                <div key={role}>
                  <div style={{ color: 'rgba(253,248,240,0.45)', fontSize: 11 }}>{role}</div>
                  <a
                    href={`tel:${num}`}
                    style={{ color: 'rgba(253,248,240,0.8)', fontSize: 14, textDecoration: 'none' }}
                  >
                    {num}
                  </a>
                </div>
          ...
          <div>
            ...
            <div style={{ marginTop: 20 }}>
              <div style={{ color: 'rgba(253,248,240,0.45)', fontSize: 11, marginBottom: 4 }}>Handle</div>
              <div style={{ color: '#E8C784', fontSize: 13 }}>@MssnUnilorin</div>
            </div>
          </div>
        </div>
